...
//
//        let weatherConsideredSchedule = weatheravailability.availabilityCheck(for: criteriadata, with: Weatherlist)
//
//
//
//        var body: some View {
...
struct WeatherAvailabilityView: View {
    let criteriaList = CriteriaList()
    let criteriadata: [Criteria] // criteriaList.getCriterias()를 지연 초기화로 변경
    
    var Weatherlist: [Weather] // 초기화를 나중으로 미룸
    
    var weatherConsideredSchedule: [String: [String]] // 초기화를 나중으로 미룸
    
    init() {
        //        criteriadata = criteriaList.getCriterias()
        //        Weatherlist = [weather1, weather2, weather3, weather4, weather5, weather6, weather7, weather8, weather9, weather10, weather11, weather12, weather13, weather14, weather15, weather16, weather17, weather18, weather19, weather20, weather21]
        //        weatherConsideredSchedule = weatherAvailability.availabilityCheck(for: criteriadata, with: Weatherlist)
        let weatherAvailability = WeatherAvailability()
        criteriadata = criteriaList.getCriterias()
        Weatherlist = [weather1, weather2, weather3, weather4, weather5, weather6, weather7, weather8, weather9, weather10, weather11, weather12, weather13, weather14, weather15, weather16, weather17, weather18, weather19, weather20, weather21]
        weatherConsideredSchedule = weatherAvailability.availabilityCheck(for: criteriadata, with: Weatherlist)
    ...
    var body: some View {
        VStack {
            Text("Weather availability") // 화면에 제목 표시
